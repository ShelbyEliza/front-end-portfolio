          ...
          <section className={styles["edu-skills-section"]}>
            ...
            <div className={styles["col-2"]}>
              <div className={styles["col-2-content"]}>
                ...
                <h3>"Self Taught"</h3>
                <p>
                  To say I am a self-taught web developer is an unfair
                  assessment. Without the seemingly infinite collections of
                  computer science knowledge available at the click of a mouse
                  and the incredible educators strewn about the internet I would
                  know close to nothing. I wouldn&#39;t be able to construct
                  useful tools like my recipe catalog,{" "}
                ...
                <p>
                  ...
                  developing on the web; followed closely by giving that
                  knowledge back to your community.
                </p>
                ...
                <ul>
                  <li>
                    ...
                    <p>
                      ...
                      subtle refinements to color and spacing lead to vibrant
                      and smooth web layouts, and that is something I treasure.{" "}
                    </p>
                  </li>
                  <li>
